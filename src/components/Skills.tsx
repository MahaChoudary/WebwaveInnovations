    ...
    <section id="skills" className="py-20 relative">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold gradient-text mb-3">Skill Matrix</h2>
      ...
      <div className="absolute inset-0 pointer-events-none -z-10">
        ...
        <div className="absolute bottom-0 right-10 w-56 h-56 bg-accent/5 rounded-full blur-3xl" />
      </div>
    </section>
  );
};
